...
void chameleonsparserParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,11,33,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,1,0,1,0,1,1,1,1,1,1,
  	...
  	5,11,0,0,23,24,5,5,0,0,24,25,5,3,0,0,25,26,3,8,4,0,26,27,5,11,0,0,27,
  	5,1,0,0,0,28,29,5,10,0,0,29,7,1,0,0,0,30,31,5,10,0,0,31,9,1,0,0,0,1,16
  };
